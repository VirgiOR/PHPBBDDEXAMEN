...
require_once('../plantillas/cabecera.php');
 ...
 ?>
    ...
    <ul>
        ...
        <li>Tipo: <?=$tipo?></li>
        <li>Color: <?=$color?></li>
        <li>Fecha_Matriculacion: <?=$fecha_matriculacion?></li>
        <li>Cilindrada: <?=$cilindrada?></li>
        <li>Itv_pasada: <?=$itv_pasada?></li>
    </ul>

    <?php 

     $consulta = 
            "insert into vehiculos(matricula,marca,modelo,tipo,color,fecha_matriculacion,cilindrada,itv_pasada) values ('$matricula','$marca',
            '$modelo''$tipo', '$color','$fecha_matriculacion','$cilindrada', $itv_pasada) ";
